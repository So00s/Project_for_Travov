...
def convert_to_numbers(string):
    ...
    Функция для перевода строки в цифровой массив в соответствии с клавиатурой йцукен
...
def convert_vyzov_to_numbers(string):
    ...
    Функция для перевода строки в цифровой массив в соответствии с клавиатурой vyzov
    На вход: слово в строковом формате
    На выход: список чисел из которых состоит это слово
    """
    list_of_num = []
